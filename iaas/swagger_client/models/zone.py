...
class Zone(object):
    ...
    def __init__(self, id=None, created_at=None, updated_at=None, owner=None, organization_id=None, org_id=None, links=None, name=None, description=None, tags=None, tags_to_match=None, placement_policy=None, custom_properties=None, folder=None):  # noqa: E501
