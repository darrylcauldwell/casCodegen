...
class ProjectApi(object):
    ...
    def update_project_resource_metadata(self, body, id, **kwargs):  # noqa: E501
        """Update project resource metadata  # noqa: E501

        Update project resource metadata by a given project id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_project_resource_metadata(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_project_resource_metadata_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_project_resource_metadata_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_project_resource_metadata_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update project resource metadata  # noqa: E501

        Update project resource metadata by a given project id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_project_resource_metadata_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
