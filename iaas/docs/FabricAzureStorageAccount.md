...
**type** | **str** | Indicates the performance tier for the storage type. Premium disks are SSD backed and Standard disks are HDD backed. | [optional] 
**external_region_id** | **str** | Indicates the ID of region. | 
