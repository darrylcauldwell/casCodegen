...
**cidr** | **str** | IPv4 address range of the network domain in CIDR format | 
**external_region_id** | **str** | The external regionId of the network domain. | 
**tags** | [**list[Tag]**](Tag.md) | A set of tag keys and optional values that were set on this network domain. | [optional] 
