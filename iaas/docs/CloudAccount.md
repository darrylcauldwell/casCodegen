...
**cloud_account_properties** | **dict(str, str)** | Cloud account specific properties | 
**enabled_region_ids** | **list[str]** | A set of region names to enable provisioning on. | [optional] 
