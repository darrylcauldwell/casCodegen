...
**external_region_id** | **str** | Unique identifier of region on the provider side. | 
**cloud_account_id** | **str** | The id of the cloud account this region belongs to. | [optional] 
