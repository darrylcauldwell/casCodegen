...
**type** | **str** | Type of datastore. | [optional] 
**external_region_id** | **str** | Id of datacenter in which the datastore is present. | [optional] 
**free_size_gb** | **str** | Indicates free size available in datastore. | [optional] 
