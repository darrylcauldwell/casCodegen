...
**snapshot_memory** | **bool** | Captures the full state of a running virtual machine, including the memory. | [optional] 
**custom_properties** | **dict(str, str)** | Additional custom properties that may be used to extend the snapshot. | [optional] 
